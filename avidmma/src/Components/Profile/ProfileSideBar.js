        ...
        <Container sx={{ flex: '0.3' }}>
            <Paper elevation={0} sx={{ m: 2, display: 'flex', flexDirection: 'column' }}>
                <Paper elevation={10} sx={{ width: '90%', display: 'flex', flexDirection: 'column', alignItems: 'center', m: "0px auto", mt: 3, pt: 5, pb: 5 }}>
                    ...
                    {user && user.photoURL ? <Avatar sx={{ p: 1, border: '.1px solid grey' }} src={user.photoURL} /> : <Avatar sx={{ p: 1 }} src='https://st3.depositphotos.com/6672868/13701/v/600/depositphotos_137014128-stock-illustration-user-profile-icon.jpg' />}
